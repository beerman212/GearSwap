...
function user_setup()
    ...
    gear.visucius_mantle.pet_engaged = {name="Visucius's Mantle",augments={}}
    gear.visucius_mantle.pet_casting = {name="Visucius's Mantle",augments={}}
...
function init_gear_sets()
    ...
    sets.precast.JA.Maneuver = {neck="Bfn. Collar +1"}
	...
	-- Weapons sets
	sets.weapons.Default = {main="",range="Turbo Animator"}
end
