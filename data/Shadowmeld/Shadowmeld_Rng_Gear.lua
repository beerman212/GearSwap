...
function init_gear_sets()
	...
	sets.precast.WS = {
		...
		body=gear.herculean.vest.agiwsd,hands="Meg. Gloves +2",ring1="Epaminondas's Ring",ring2="Dingir Ring",
		back=gear.belenus.wsd.ranged,waist="Fotia Belt",legs="Meg. Chausses +2",feet=gear.herculean.boots.agiwsd}
	...
	sets.precast.WS["Jishnu's Radiance"] = set_combine(sets.precast.WS, {
		...
		back=gear.belenus.jishnu,legs="Darraigner's Brais",feet="Adhe. Gamashes +1"
	})
	sets.precast.WS["Jishnu's Radiance"].Acc = set_combine(sets.precast.WS["Jishnu's Radiance"], {
		head="Orion Beret +3",legs=gear.herculean.trousers.ranged_crit,feet="Meg. Jam. +2"})
	...
	sets.precast.WS.Decimation = set_combine(sets.precast.WS, {
		...
		body="Adhemar Jacket +1",hands=gear.adhemar.wrist.path_b,ring1="Shukuyu Ring",ring2="Ilabrat Ring",
		back=gear.belenus.stp.melee,legs="Meg. Chausses +2",feet=gear.herculean.boots.ta})
	...
	sets.precast.WS.Evisceration = set_combine(sets.precast.WS, {
		head="Adhemar Bonnet +1",ear1="Sherida Earring",
		body="Abnoba Kaftan",hands=gear.adhemar.wrist.path_b,ring1="Ilabrat Ring",ring2="Mummu Ring",
		back=gear.belenus.stp.melee,legs="Samnuha Tights",feet="Mummu Gamashes +2"})
	...
	sets.midcast.RA = {
		...
		body="Oshosi Vest",hands=gear.adhemar.wrist.path_c,ring1="Ilabrat Ring",ring2="Dingir Ring",
		back=gear.belenus.stp.ranged,waist="Yemaya Belt",legs="Adhemar Kecks",feet="Adhe. Gamashes +1"}
	...
	sets.idle = {
		...
		body="Meg. Cuirie +2",hands="Meghanada Gloves +2",ring1="Defending Ring",ring2=gear.dark_ring.dt,
		back=gear.belenus.stp.melee,waist="Flume Belt",legs="Mummu Kecks +2",feet="Ahosi Leggings"}
	...
	sets.engaged = {
		...
		back=gear.belenus.stp.melee,waist="Windbuffet Belt +1",legs="Samnuha Tights",feet=gear.herculean.boots.ta}

	sets.engaged.Acc = {
		head="Carmine Mask +1",neck="Lissome Necklace",ear1="Telos Earring",ear2="Sherida Earring",
		body="Adhemar Jacket +1",hands=gear.adhemar.wrist.path_b,ring1="Chirich Ring",ring2="Epona's Ring",
		back=gear.belenus.stp.melee,waist="Grunfeld Rope",legs="Carmine Cuisses +1",feet="Carmine Greaves +1"}
